...
public class Level_16_Log extends BaseTest {
	...
	public void TC3_Confirm_Info_Login() {
		log.info("User_01 - Step 17: Click To Link My Account");
		myAccountPageObject = homePageObject.clickToLinkMyAccount();
		log.info("User_01 - Step 18: Verify Value First Name ");
		verifyEquals(myAccountPageObject.getValueFirstName(), "lune");
		log.info("User_01 - Step 18: Verify Value Last Name ");
		verifyEquals(myAccountPageObject.getValueLastName(), "susi");
		log.info("User_01 - Step 18: Verify Value Email ");
